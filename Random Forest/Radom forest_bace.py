...
feature_cols = ['LogP', 'MW', 'HBD',"Charge","EWG_count",'AG_count']
#GRPO ['LogP', 'MolecularWeight', 'HBD',"Charge","ElectronWithdrawingGroups_count",'AmideGroup_count'] 0.7982  #0.7469
#DAPO ['LogP', 'MolecularWeight', 'HBD', 'HBA',"Charge","ElectronWithdrawingGroups_count",'AmideGroup_count'] 0.7842 #0.7384
...
param_grid = {
    'n_estimators': [100, 120, 140, 160, 180,198 ,200],
...
plt.title('BACE Feature Importance in BACE Task')
plt.tight_layout()
plt.savefig('bace_attributes_important.pdf', format='pdf', bbox_inches='tight')
plt.show()


joblib.dump(best_model, 'best_rf_model_bace.pkl')
print("✅ Model saved to 'best_rf_model_bace.pkl'")
...
visual_tree.fit(X_input, y_input)
